        ...
        <section className="text-gray-600 body-font mt-15">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div
                    ...
                    <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Welcome To Our
                        <br className="hidden lg:inline-block"/>Sim-E-Com
                    </h1>
                    ...
                    <div className="flex justify-center">
                        <Link
                            className=" btn inline-flex text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg" to="/shop">Shop
                        </Link>
                    </div>
                </div>
            </div>
